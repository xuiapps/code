...
/// <summary>
/// Demonstrates reversed flex directions (RowReverse and ColumnReverse).
/// Shows how items are laid out in reverse order along the main axis.
/// </summary>
public class ReverseDirectionTest : View
{
        ...
        return new LabeledFlexBox
        {
            ...
            FlexBox = new global::Xui.Core.UI.Layout.FlexBox
            {
                ...
                [
                    ...
                    Box("4", palette[3], 60, 40),
                    Box("5", palette[4], 60, 40),
                ]
            }
        };
    }
        ...
        return new LabeledFlexBox
        {
            ...
            FlexBox = new global::Xui.Core.UI.Layout.FlexBox
            {
                ...
                [
                    ...
                    Box("2", palette[1], 100, 25),
                    Box("3", palette[2], 100, 25),
                    Box("4", palette[3], 100, 25),
                ]
            }
        };
    }
    ...
    private class LabeledFlexBox : View
    {
        ...
        protected override Size MeasureCore(Size availableSize, IMeasureContext context)
        {
            FlexBox?.Measure(new Size(availableSize.Width - 120, Height), context);
            return new Size(availableSize.Width, Height);
        }

        protected override void ArrangeCore(Rect rect, IMeasureContext context)
        {
            FlexBox?.Arrange(new Rect(rect.X + 120, rect.Y, rect.Width - 120, Height), context);
        }
        ...
        protected override void RenderCore(IContext context)
        {
            ...
            context.FillText(Label, new Point(Frame.X + 57.5f, Frame.Y + Frame.Height / 2));
