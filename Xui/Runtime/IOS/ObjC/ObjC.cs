...
public static partial class ObjC
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void SelfSel_Callback(nint self, nint sel);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool SelfSelIdId_RetBool_Callback(nint self, nint sel, nint id1, nint id2);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void SelfSelId_Callback(nint self, nint sel, nint sender);

    // [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    // public delegate void SelfSelNSRect_Callback(nint self, nint sel, NSRect rect);
    ...
    [LibraryImport(LibObjCLib, EntryPoint = "class_addMethod")]
    [return: MarshalAs(UnmanagedType.I1)]
    private static unsafe partial bool class_addMethod(nint objcclass, nint name, [MarshalAs(UnmanagedType.FunctionPtr)] IdSelCGRect_Void fun, [MarshalAs(UnmanagedType.LPStr)] string types);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void IdSelCGRect_Void(nint self, nint sel, CGRect rect);
