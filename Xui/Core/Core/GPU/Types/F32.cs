...
public readonly struct F32
{
    ...
    /// </summary>
    public static implicit operator F32(double value) => new((float)value);

    /// <summary>
    /// Converts from nfloat to F32.
    /// </summary>
    public static implicit operator F32(nfloat value) => new((float)value);
    ...
    /// </summary>
    public static implicit operator double(F32 value) => value._value;

    /// <summary>
    /// Converts from F32 to nfloat.
    /// </summary>
    public static implicit operator nfloat(F32 value) => value._value;
