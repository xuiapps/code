...
public struct LayoutGuide
{
    ...
    /// meaning the view can process the full pipeline in a single DFS walk via <see cref="View.Update(LayoutGuide)"/>.
    /// </summary>
    ...
    public enum LayoutPass : byte
    {
        ...
        /// When a guide carries this value, <see cref="View.Update(LayoutGuide)"/> is eligible for
